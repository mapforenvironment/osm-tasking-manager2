...
<div class="container">
  <div class="row">
    <div class="col-md-7">
      ...
      <p>${_('Map for Environment - OSM Tasking Manager was designed and built for the <a href="http://hot.openstreetmap.org">Humanitarian OpenStreetMap Team</a>.') |n}
    ...
    <div class="col-md-5">
      ...
      <p>
        ...
        ${_('with the help of <a href="https://github.com/mapforenvironment/osm-tasking-manager2/graphs/contributors">other contributors</a>.') |n}
      </p>
<%
